...
export default function About() {
  return (
    <div className='container my-3 about_container'>
      <h3>All about ToDo's List!</h3>
        <p>Do you often feel overwhelmed by the amount of work you have to do? Do you find yourself missing deadlines? Or do you sometimes just forget to do something important, so that people have to chase you to get work done?
        ...
        In fact, it's often when people start to use them effectively and sensibly that they make their first personal productivity breakthroughs, and start making a success of their careers. The video, below, gives some tips on how you can start to use to-do lists more effectively.</p>
    </div>
  )
}
